...
export const preTestQuestions: Question[] = [
  ...
  {
    question:
      'Rodel has 11/4 packets of clay. If he crafts a sculpture using 5/3 packets, how much clay does he have left?',
  ...
  {
    question:
      'You bought three boxes of 12 inch pizza as your birthday present for your mother for her 60th birthday. If the sum of the slice of pizzas is 24/8 and your family already ate 3/2 of its portion, how many pizza slices were left?',
    answers: ['12/8', '3/2'],
  ...
  {
    question:
      'Analene caught fish weighing 5 and 2/3 kg. She gave 3 and 1/6 kg of fish to Cj, how many kilograms does Analene have left?',
    answers: ['2 3/6', '2 1/2 kg of fish'],
    solutions: ['5 2/3 - 3 1/6 ='],
  },
  {
    question:
      'Sheila found that her car tank is running out of gas and it only has 1/8 gas so she decided to go to the nearest gasoline station. If she would like to fill it up to 3/4 of its tank, how much gasoline should she add? (5/8)',
    answers: ['5/8'],
    solutions: ['3/4 - 1/8'],
  },
  {
    question:
      "Yesterday, Joseph's family ate 14/7 kilos of Mangoes and 38/12 kilos of Avocados. What were the total kilograms of fruits they ate?",
    answers: ['31/6', '5 and 1/6 kilos of fruits'],
    solutions: ['14/7 + 38/12 ='],
  },
  {
    question:
      'Angeline walked 2/7 kilometers and stopped at the nearest convenience store to buy snacks and to rest. She then walked 5/9 kilometers again to see her best friend at the park. What was the total distance she walked?',
    answers: ['53/63 kilometers'],
    solutions: ['2/7 + 5/9 ='],
  },
  {
    question:
      'A recipe needs 7/4 teaspoon of soy sauce and 1/2 teaspoon of Vinegar. How much more Soy Sauce does the recipe need?',
    solutions: ['7/4-1/2='],
    answers: ['5/4 teaspoon of Soy Sauce'],
  },
  {
    question:
      'Today is your graduation, and your parents decided to buy you caramel and chocolate chip cakes for a small celebration. To share your success with others, you decided to share it with some of your neighbors. You gave off 2/9 of your caramel cake and 1/3 of your chocolate chip cake. How many cakes were left if the remaining caramel and chocolate chip cake were combined?',
    solutions: [
