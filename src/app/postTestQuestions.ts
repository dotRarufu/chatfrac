...
export const postTestQuestions: Question[] = [
  ...
  },
  {
    ...
    answers: ['23/10', '2 and 3/10', '2 3/10'],
  },
  ...
  {
    content: {
      text: '30. Today is your graduation, and your parents decided to buy you caramel and chocolate chip cakes for a small celebration. To share your success with others, you decided to share it with some of your neighbors. You gave off 2/9 of your chocolate cake and 1/3 of your caramel chip cake. How many cakes were left if the remaining caramel chip cake and chocolate cake were combined?',
    },
    solutions: [
      'For caramel cake,',
      '9/9 - 2/9 = 7/9',
